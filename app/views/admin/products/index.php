...
<head>
  ...
  <link rel="stylesheet" href="/views/admin/products/style.css">
  <script defer src="/views/admin/products/script.js"></script>
...
<body>
    ...
    <main class="main">
        ...
        <div class="summary-container">
          <div class="summary-card">
            <div class="summary-info">
              ...
              <p class="summary-figure summary-figure--product">150000</p>
            </div>
            <ion-icon name="apps-outline" class="summary-icon"></ion-icon>
          </div>
          <div class="summary-card">
            <div class="summary-info">
              <p class="summary-title margin-bottom-very-small">Bestseller products</p>
              <p class="summary-figure summary-figure--bestseller-product">150000</p>
            </div>
            <ion-icon name="analytics-outline" class="summary-icon"></ion-icon>
          </div>
          <div class="summary-card">
            <div class="summary-info">
              <p class="summary-title margin-bottom-very-small">Highest rated products</p>
              <p class="summary-figure summary-figure--highest-rated-product">150000</p>
            </div>
      ...
      <section class="section-button margin-bottom-small">
        <div class="button-container">
          <button class="btn btn--new-product">
            <ion-icon name="add-outline" class="add-icon icon-link"></ion-icon>
            <p class="btn--new-product">New product</p>
          </button>
        </div>
      </section>
      ...
      <section class="section-search margin-bottom-small">
        <form class="search-form">
          <input type="search" placeholder="Enter a product" class="search-input">
        ...
        <table class="products-table margin-bottom-medium">
          <thead>
            <tr>
              ...
              <th class="table-header-category-name">Product name</th>
              <th class="table-header-menu-name">Menu name</th>
              <th class="table-header-menu-name">Category name</th>
              <th class="table-header-menu-name">Type name</th>
  ...
  <div class="modal new-product-modal hidden">
    <button class="btn--close-modal btn--close-create-modal">&times;</button>
    <h2 class="heading-secondary margin-bottom-small">Create product</h2>
    <form class="modal-form create-form" novalidate>
      <label class="label" for="create-product-name-input">Product name</label>
      <div class="input-info">
        <input type="text" placeholder="Product name" class="input" name="product-name" id="create-product-name-input">
        <p class="error product-name-error" id="create-product-name-error"></p>
      </div>
      ...
      <div class="input-info">
        <input type="text" placeholder="Category name" class="input" name="caetgory-name" id="create-category-name-input">
      ...
      <div class="input-info">
        <textarea class="textarea create-description-textarea" placeholder="Describe about category" id="create-description-textarea" rows="5" cols="30"></textarea>
        <p class="error description-error" id="create-description-error"></p>
      </div>

      <button type="submit" class="btn btn--submit margin-top-small">Create new category</button>
    </form>
  </div>

  <div class="modal edit-product-modal hidden">
    <button class="btn--close-modal btn--close-edit-modal">&times;</button>
    <h2 class="heading-secondary margin-bottom-small">Edit product</h2>
    <form class="modal-form edit-form" novalidate>
      ...
      <label class="label" for="edit-product-name-input">Product name</label>
      <div class="input-info">
        <input type="text" placeholder="Product name" class="input" name="product-name" id="edit-product-name-input">
        <p class="error product-name-error" id="edit-product-name-error"></p>
      </div>
      ...
      <div class="input-info">
        <textarea class="textarea edit-description-textarea" placeholder="Describe about menu" id="edit-description-textarea" rows="5" cols="30"></textarea>
  ...
  <div class="modal delete-product-modal hidden">
    <button class="btn--close-modal btn--close-delete-modal">&times;</button>
    <h2 class="heading-secondary margin-bottom-small">Delete product</h2>
    <form class="modal-form delete-form" novalidate>
      ...
      <label class="label" for="delete-product-name-input">Product name</label>
      <div class="input-info">
        <input type="text" placeholder="Id" class="input" name="product-name" id="delete-product-name-input" readonly>
      </div>
      ...
      <div class="input-info">
        <input type="text" placeholder="Category name" class="input" name="category-name" id="delete-category-name-input" readonly>
      </div>
      <label class="label" for="delete-type-name-input">Type name</label>
      <div class="input-info">
        <input type="text" placeholder="Type name" class="input" name="type-name" id="delete-type-name-input" readonly>
      </div>
      <button type="submit" class="btn btn--submit margin-top-small">Delete product</button>
    </form>
  </div>

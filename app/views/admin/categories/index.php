...
<head>
  ...
  <link rel="stylesheet" href="/views/admin/categories/style.css">
  <script defer src="/views/admin/categories/script.js"></script>
...
<body>
    ...
    <main class="main">
      ...
      <section class="section-button margin-bottom-small">
        <div class="button-container">
          <button class="btn btn--new-menu">
            <ion-icon name="add-outline" class="add-icon icon-link"></ion-icon>
            <p class="btn--new-menu">New category</p>
          </button>
        </div>
      </section>
      ...
      <section class="section-search margin-bottom-small">
        <form class="search-form">
          <input type="search" placeholder="Enter a menu" class="search-input">
        ...
        <table class="products-table margin-bottom-medium">
          <thead>
            <tr>
              ...
              <th class="table-header-category-name">Category name</th>
  ...
  <div class="modal new-category-modal hidden">
    <button class="btn--close-modal btn--close-create-modal">&times;</button>
    <h2 class="heading-secondary margin-bottom-small">Create category</h2>
    <form class="modal-form create-form" novalidate>
      ...
      <div class="input-info">
        <textarea class="textarea create-description-textarea" placeholder="Describe about category" id="create-description-textarea" rows="15" cols="30"></textarea>
  ...
  <div class="modal edit-category-modal hidden">
    <button class="btn--close-modal btn--close-edit-modal">&times;</button>
    <h2 class="heading-secondary margin-bottom-small">Edit category</h2>
  ...
  <div class="modal delete-category-modal hidden">
    ...
    <form class="modal-form delete-form" novalidate>
      ...
      <div class="input-info">
        <input type="text" placeholder="Id" class="input" name="id" id="delete-category-name-input" readonly>
      </div>
